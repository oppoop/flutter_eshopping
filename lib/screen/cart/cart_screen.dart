...
class _CartScreenState extends State<CartScreen> {
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      item.product.name!,
                      style:
                          GoogleFonts.notoSerif().copyWith(color: Colors.white),
                    ),
                    Divider(
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            onChanged: (String productNum) {
                              productNum = _numController.text;
                            },
                      ...
                      onPressed: () {
                        ...
                        context.read<CartNotifier>().add(
                              OrderItem(
                                product: item.product,
                                selectedSize:
                                    item.product.sizes![_sizeCurrent!],
  ...
  Widget build(BuildContext context) {
    List<Widget> orderItemRows = context
        .watch<CartNotifier>()
        .itemsInCart
        .map(
          (item) => Row(
